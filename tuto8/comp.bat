...
:: compile the sources
ccpsx -O3 -Xo$80010000 main.cpp System.cpp Sprite.cpp Sprite_textured.cpp Cube.cpp Pad.cpp Texture.cpp ../global_src/TRAINTEX.C -otuto8.cpe,tuto8.sym,mem.map -llibpress -llibpad
