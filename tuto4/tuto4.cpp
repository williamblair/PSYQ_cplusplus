...
void tuto4::init3D(int x, int y, int z)
{
...
void tuto4::addCubeF4(u_long *ot, POLY_F4 *s, MATRIX *rottrans, CVECTOR *c)
{
    int i;
    long p, otz, opz, flg;
    int isomote;
